/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 910f371ce27df22690b96fc6022fe591)
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "GameRoom" | "ChunkStore";
	}
	interface StagingEnv {
		GameRoom: DurableObjectNamespace<import("./src/server/index").GameRoom>;
		ChunkStore: DurableObjectNamespace<import("./src/server/index").ChunkStore>;
	}
	interface Env {
		GameRoom: DurableObjectNamespace<import("./src/server/index").GameRoom>;
		ChunkStore: DurableObjectNamespace<import("./src/server/index").ChunkStore>;
		ChunkGen?: Service<typeof import("./src/server/index").ChunkGen>;
	}
}
