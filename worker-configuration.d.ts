/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 5dcd3cde2945a1e795674d64268f6ac7)
...
declare namespace Cloudflare {
	...
	interface StagingEnv {
		GameRoom: DurableObjectNamespace<import("./src/server/index").GameRoom>;
		ChunkGen: Service /* entrypoint ChunkGen from minceraft-staging */;
	}
	interface Env {
		GameRoom: DurableObjectNamespace<import("./src/server/index").GameRoom>;
		ChunkGen: Service /* entrypoint ChunkGen from minceraft-staging */ | Service<typeof import("./src/server/index").ChunkGen>;
	}
}
